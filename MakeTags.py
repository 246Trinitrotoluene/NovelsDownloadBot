...
json1 = os.path.join(os.getcwd(), "tags.json")  # 主要数据文件
json2 = os.path.join(os.getcwd(), "tagsused.json")
json3 = os.path.join(os.getcwd(), "tagsen.json")
json4 = os.path.join(os.getcwd(), "tagscn.json")
races = {
	"熊": "bear",
	"熊猫": "panda",
	"马": "horse",
